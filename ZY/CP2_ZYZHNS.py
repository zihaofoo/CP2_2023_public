...
##         size = 1
## 
##         # Explore neighboring cells in 4 directions (up, down, left, right)
##         size += dfs(grid, row - 1, col, target, visited)
##         size += dfs(grid, row + 1, col, target, visited)
##         size += dfs(grid, row, col - 1, target, visited)
##         size += dfs(grid, row, col + 1, target, visited)
##         size += dfs(grid, row - 1, col - 1, target, visited)  # Up-Left
##         size += dfs(grid, row - 1, col + 1, target, visited)  # Up-Right
##         size += dfs(grid, row + 1, col - 1, target, visited)  # Down-Left
##         size += dfs(grid, row + 1, col + 1, target, visited)  # Down-Right
##         
##         return size
##     return 0
## 
## def find_largest_cluster(grid, target):
...
##                 cluster_size = dfs(grid, row, col, target, visited)
