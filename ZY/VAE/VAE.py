...
grids = np.load('grids_augmented_day1.npy') #Helper function we have provided to load the grids from the dataset
...
torch.save(model, 'VAE_model_w_good_data' + '.pth')

# # Later on, to load the entire model
# VAE_model = torch.load('VAE_model_w_good_data' + '.pth')
